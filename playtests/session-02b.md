# Playtest Session 2b: The Harrow (Episode 2, Cold Open + Act One)
...
**Note:** Episode paused at end of Act One. Bomb named, Slide not started.
...
**Session paused here.** Act Two (the Slide) has not started.
...
## Thread State at Pause

| # | Thread | Status |
|---|--------|--------|
| 1 | ~~Who changed the ship's course?~~ | Partially resolved, branched |
...
| 2.2 | Who is speaking on the recording? | Cold |
| 2.3 | What does "tell Lian" mean? | Open |
| 3.3 | Whose side is Judith on? | Open (new) |
...
| 5.2.1 | ~~Why does Jun's model match Lian's biology?~~ | Resolved (Clarity): Lian is the interface |
| 5.2.1.1 | What is on the other end of the bridge? | Open (new) |
| 5.2.1.2 | Did Jun do this to Lian knowingly? | Open (new) |
| 5.2.1.3 | What happens to Lian if the partition is destroyed? | Open (new) |
| 5.3 | What is at the deviation point? | Open |
| 5.3.1 | What is alive at the deviation point? | Open |
...
- The Cold Open loaded fast again. Four positions, four tensions, under five minutes.
- Scene B with no pull was the most memorable moment of the session.
- Maren's diagnostic attack as a pull was creative and felt natural within the rules.
...
- Daal's escape plan (thread 11 + 3.3). He wants to leave, Judith is helping him. If he leaves, does the bridge to Lian break? Does it matter?
- Judith's agency (thread 3.3). She helped Daal, she reported Lian as normal. Whose side is she on? If the partition is inside her too, is she compromised or protecting herself?
