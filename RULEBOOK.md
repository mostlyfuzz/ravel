...
Ravel is a tabletop roleplaying game about characters and the threads that connect them. There are no hit points, no skill lists, no combat rounds. Just a web of relationships, questions, and tensions, and a simple engine for pulling on them to see what unravels.
